...
# Exercise 3: Total column
df1["Total"] = df1[["Math", "English", "Science"]].sum(axis=1)

# Exercise 4: Bar chart for subject averages
subject_avgs = df1[["Math", "English", "Science"]].mean()
subject_avgs.plot(kind="bar", title="Average Grades per Subject", ylabel="Average Grade", xlabel="Subject")
plt.tight_layout()
plt.show()
...
highest_day = df2.loc[df2["Total_Sales"].idxmax()]["Date"]
...
print("Total Sales:\n", total_sales)
print("Date with Highest Sales:", highest_day)
...
# Exercise 4: Bar chart of employee count by department
